...
export const DEFAULT_SUGGESTIONS = [
  ...
  "ออกแบบทริป 3 วัน 2 คืน ในเชียงใหม่",
  "What's the weather in Bangkok today?",
  "ช่วยสรุปบทเรียนหัวข้อที่กำลังอ่านอยู่ให้เข้าใจง่ายขึ้น",
] as const;
...
/** Cloudflare Workers SDK — ชื่อ binding ของ agent บน Worker */
export function getCfAgentName(slug: string | null | undefined): string {
  if (slug === "image") return "ImageAgent";
  if (slug === "fitness-coach" || slug === "fitness") return "FitnessCoachAgent";
