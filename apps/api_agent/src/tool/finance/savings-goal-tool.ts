...
export const savingsGoalTool = tool({
  ...
  inputSchema: z.object({
    ...
    goalAmount: z.coerce.number().min(0).describe('Total desired savings in the user currency'),
    months: z
      .coerce.number()
      .min(1)
      .max(600)
    ...
    allowRounding: z
      .boolean()
      .default(true)
      .describe('If true, round suggested monthly saving to nearest whole unit')
  }),
